...
--====================================================================--
-- DRAG & RESIZE (HOLD-TO-RESIZE, NO AUTO-GROW)
--====================================================================--
local dragging = false
local scaling  = false
local dragStart, startPos
local scaleStart, startSize
...
-- **Hold-to-resize** – only updates while mouse is held down
scaleBtn.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 then
		scaling    = true
...
scaleBtn.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 then
		scaling = false
	end
end)
...
UserInputService.InputChanged:Connect(function(input)
	if scaling and input.UserInputType == Enum.UserInputType.MouseMovement then
		local delta = input.Position - scaleStart
...
--====================================================================--
selectTab("Spawner")
print("Scripts.SM Loaded – Hold & drag the corner to resize!")
